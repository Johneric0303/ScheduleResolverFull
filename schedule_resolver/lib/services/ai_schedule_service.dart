...
class AiScheduleService extends ChangeNotifier {
  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      Your job us is to analyze these tasks, identify any overlaps or conflicts in their start and end times, and suggest a better balanced schedule,
      ...
      Provide a revised daily timeline view adjusting the task times to resolve conflicts and balance the students worksload, study time and rest.
      4. ### Explanation
      Explain why this recommendation was made in simple that a student would easily understand.
  ...
  ScheduleAnalysis _parseResponse(String fullText) {
    ...
    for (var section in sections) {
      ...
      else if (section.startsWith('Ranked Task'))
        rankedTasks = section.replaceFirst('Rank Taskss', '').trim();
